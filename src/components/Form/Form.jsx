...
<div className={`${classes.wrapper}`}>
    <div className={`${classes.container} w-4/5 lg:w-2/3 mx-auto`}>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className={`${classes['form-container']}`} noValidate >
            ...
            <div ref={nameRef} className={`${classes['form-name']} bg-purple relative ${nameInView ? `${classes['show-name']}` : `${classes['hide-name']}`}`}>
            ...
            <div ref={emailRef} className={`${classes['form-email']} bg-darkGreen ${emailInView ? `${classes['show-email']}` : `${classes['hide-email']}`}`}>
            ...
            <div ref={textRef} className={`${classes['form-message']} bg-grayishWhite ${textInView ? `${classes['show-text']}` : `${classes['hide-text']}`}`}>
            <textarea className='text-xl lg:text-2xl' placeholder='Message' name="message" id="message" 
            {...register('message', {
